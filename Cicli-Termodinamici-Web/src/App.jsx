...
const simulators = [
  ...
  },
  {
    title: 'Ciclo Otto',
    id: 'otto',
    description: 'Motore ad accensione comandata (benzina). Analizza compressione e combustione isocora.',
    Icon: Zap,
    color: '#FCD34D',
  },
  {
    title: 'Ciclo Diesel',
    id: 'diesel',
    description: "Motore ad accensione spontanea. Varia il rapporto di cut-off e osserva l'effetto sul rendimento.",
    Icon: Flame,
    color: '#EF4444',
  },
  {
    ...
    id: 'frigo',
    description: 'Refrigerazione a compressione di vapore con piu refrigeranti. Calcola COP e capacita frigorifera.',
    Icon: Snowflake,
    color: '#10B981',
  },
  {
