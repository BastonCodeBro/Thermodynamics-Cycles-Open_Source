...
const buildCarnotDisplayResult = (cycle, activeMode) => {
...
const CarnotPage = () => {
  ...
  return (
    <IdealGasCyclePage
      ...
      resolveResult={async (values, activeMode) => resolveCycleDisplayResult({
        cycleId: 'carnot',
        mode: activeMode === 'reverse' ? 'reverse' : 'engine',
        family: 'ideal-gas',
        inputs: {
        ...
        computeLocalResult: async () => (activeMode === 'reverse'
        ...
        mapResultToDisplay: (cycle) => buildCarnotDisplayResult(cycle, activeMode),
      })}
